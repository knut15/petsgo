...
const PROVIDERS: Array<{
  ...
  { id: 'kakao', label: '카카오로 계속하기', bgClass: 'bg-[#fee500]', textClass: 'text-[#3c1e1e]', icon: '💬' },
  { id: 'google', label: 'Google로 계속하기', bgClass: 'bg-white border border-stone-300', textClass: 'text-stone-800', icon: 'G' },
];
    ...
    <div className="min-h-screen bg-stone-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-stone-900 mb-2">로그인 / 가입</h1>
